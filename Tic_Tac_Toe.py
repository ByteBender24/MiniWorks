...
#small errors
'''
SHould not overwrite the values of X with O and O with X when given at same coordinate
Should print win or lose as soon as there is a strike, not wait for inputs of two users
